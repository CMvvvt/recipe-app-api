...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_full_update(self):
        ...
        recipe = create_recipe(
            user=self.user,
            title='Sample recipe title',
            link='https://examplpe.com/recipe.pdf',
    ...
    def test_create_tag_on_update(self):
        """Test creating tah when updateing a recipe."""
        recipe = create_recipe(user=self.user)
    ...
    def test_update_recipe_assign_tag(self):
        """Test assinging an existing tah when updating a recipe."""
    ...
    def test_create_recioe_with_new_ingredient(self):
    ...
    def test_create_recipe_with_exsiting_ingredient(self):
    ...
    def test_filter_by_ingredients(self):
        ...
        in2 = Ingredient.objects.create(user=self.user, name='Chicken Ing')
